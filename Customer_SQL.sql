...
select gender as Gender,sum(purchase_amount) as Revenue from customer
group by gender;
...
select shipping_type ,round(avg(purchase_amount),2) as revenue from customer
...
, sum(purchase_amount) as total_spend from customer
